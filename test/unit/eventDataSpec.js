// eventDataSpec.js  Service testing
'use strict';
...
describe('eventData', function(){
	...
	it('should shold issue a GET request to /data/event/11 when getEvent is called and the id is 11', inject(function(eventData, $httpBackend){
